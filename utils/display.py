...
from tkinter import Tk, Label, Frame, NW, NE, S, W, SW, SE, END, CENTER
...
# time.after(30000, clock.get_clock_info)
...
##TODO: (medium priority)change the background and foreground color!
##TODO: removed borders
style = Style()
style.theme_use("alt")
style.configure(
    "Treeview",
