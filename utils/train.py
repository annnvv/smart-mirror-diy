...
class Wmata(configData):
    ...
    ##TODO2: limit requests only during when the train is running
    ##TODO3: in order to implement above, need to
    ...
    def get_next_train(self) -> None:
        ...
        ##TODO1: maybe implement this as a dictionary rather than a nested list???
        self.train_info = []
        if train_obj["Trains"]:
